...
const crustSeeds = 'man laptop chimney debate grit impact fee pony exchange away ritual lady'; // Create account(seeds): https://wiki.crust.network/docs/en/crustAccount
